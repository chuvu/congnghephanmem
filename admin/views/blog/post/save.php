...
<div id="content">
    <div class="page-header">
        <div class="container">
            ...
            <h1><?php echo $mode == 'create' ? 'Viết bài tại ' . $category->name : $post->name ?></h1>
            <ul class="breadcrumb">
        ...
        <div role="tabpanel">
            <ul class="nav nav-tabs nav-justified" role="tablist">
                <li role="presentation" class="active">
                    <a href="#post" aria-controls="post" role="tab" data-toggle="tab"><i class="fa fa-file-o"></i> Bài đăng</a>
                </li>
                <li role="presentation">
                    <a href="#discuss" aria-controls="discuss" role="tab" data-toggle="tab"><i class="fa fa-discussions"></i> Thảo luận</a>
                </li>
            </ul>
        
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="post">
                    <form data-toggle="ajax-form" method="post" action="<?php echo $mode == 'create' ? 'api/blog/post/store' : 'api/blog/post/'. $post->id .'/update' ?>">
                        <input type="hidden" name="redirect" value="<?php echo url('blog/category/' . $category->id) ?>">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-file-o"></i> Nội dung bài viết</h3>
                            </div>
                            <div class="panel-body">
                                <div class="">
                                    <div class="form-group">
                                        <input type="text" value="<?php echo $post->name ?>" class="form-control" name="name" placeholder="Tên bài" />
                                    </div>
                                    <div class="form-group">
                ...
                <div role="tabpanel" class="tab-pane" id="discuss">
                    <?php if ($mode == 'create') : ?>
                        Chỉ có thể thảo luận khi đã lưu bài viết
                    <?php else : ?>
                            ...
                            <table class="table master-table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <?php if ($discussions) : ?>
                                        <?php foreach ($discussions as $discussion) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo url('blog/discussion/' . $discussion->id) ?>"><strong><?php echo $discussion->name ?></strong></a>    
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-right">
                                                    <a href="<?php echo url('blog/discussion/' . $discussion->id) ?>" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                                    ...
                                    <?php else : ?>
                                        <tr>
                                            <td colspan="6">
                                                <i class="fa fa-warning"></i> Không có chủ đề thảo luận nào!
                                            </td>
                                        </tr>
                                    <?php endif ?>
                                </tbody>
